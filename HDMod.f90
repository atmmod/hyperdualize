      ...
      !----- DBLE (conversion to double)
        ...
        !----- MAX
          ...
          function max_hdual_dble_SPRhyd(q1, x2) result(q_out)
              ...
              if (real(q1%x, SPRhyd) .GE. x2) then
                q_out = q1
              else
          ...
          function max_dble_hdual_SPRhyd(x1, q2) result(q_out)
            ...
            if (x1 .GE. REAL(q2%x, SPRhyd)) then
          ...
          function max_hdual_matrix_dble_SPRhyd(q1,x1) result(q_out)
            ...
            do I = 1, size(q1,1)
              do J = 1, size(q1, 2)
                if (REAL(q1(I,J)%x, SPRhyd) .GE. x1) then
                  q_out(I,J) = q1(I,J)
                else
          ...
          function max_hdual_tens_dble_SPRhyd(q1,x1) result(q_out)
            ...
            do I = 1, size(q1,1)
              do J = 1, size(q1, 2)
                do K = 1, size(q1, 3)
                  if (REAL(q1(I,J,K)%x, SPRhyd) .GE. x1) then
                    q_out(I,J,K) = q1(I,J,K)
                  else
          ...
          function max_hdual_4d_dble_SPRhyd(q1,x1) result(q_out)
            ...
            do I = 1,size(q1, 1)
              do J = 1,size(q1, 2)
                do K = 1,size(q1, 3)
                  do L = 1,size(q1, 4)
                    if (REAL(q1(I,J,K,L)%x, SPRhyd) .GE. x1) then
                      q_out(I,J,K,L) = q1(I,J,K,L)
                    else
          ...
          function max_three_hdual(q1, q2, q3) result(q_out)
            ...
            if (q2%x .GT. q_out%x) then
              q_out = q2
            end if
            
            if (q3%x .GT. q_out%x) then
              q_out = q3
            end if
        ...
        !----- MIN
          ...
          function min_hdual_dble_SPRhyd(q1, x2) result(q_out)
            ...
            if (REAL(q1%x, SPRhyd) .LE. x2) then
              q_out = q1
            else
              q_out%x = REAL(x2,PRhyd)
              q_out%dx1 = 0.0_PRhyd
         ...
         function min_hdual_four(q1, q2, q3, q4) result(q_out)
            ...
            if  (q2%x .LT. q_out%x) then
              q_out = q2
            endif
  
            if (q3%x .LT. q_out%x) then
              q_out = q3
            endif

            if (q4%x .LT. q_out%x) then
              q_out = q4
            endif
